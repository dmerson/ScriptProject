...
#rawHTML <- paste(readLines("Screenplays/La La Land Script at IMSDb..html"), collapse="\n")
la_la_land_script <- read_html("Screenplays/La La Land Script at IMSDb..html") %>%
              html_node("pre") %>%
              html_text()
la_la_script_lines <-read_lines(la_la_land_script)
